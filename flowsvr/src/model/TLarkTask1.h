...
class TLarkTask1
{
  public:
     ...
     */
    explicit TLarkTask1(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit TLarkTask1(const Json::Value &pJson) noexcept(false);
     ...
     */
    TLarkTask1(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<TLarkTask1>;
    friend drogon::orm::BaseBuilder<TLarkTask1, true, true>;
    friend drogon::orm::BaseBuilder<TLarkTask1, true, false>;
    friend drogon::orm::BaseBuilder<TLarkTask1, false, true>;
    friend drogon::orm::BaseBuilder<TLarkTask1, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<TLarkTask1>;
#endif
