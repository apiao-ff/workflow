...
const std::string TTask::Cols::_id = "id";
const std::string TTask::Cols::_user_id = "user_id";
const std::string TTask::Cols::_task_id = "task_id";
const std::string TTask::Cols::_task_type = "task_type";
const std::string TTask::Cols::_task_stage = "task_stage";
const std::string TTask::Cols::_status = "status";
const std::string TTask::Cols::_priority = "priority";
const std::string TTask::Cols::_crt_retry_num = "crt_retry_num";
const std::string TTask::Cols::_max_retry_num = "max_retry_num";
const std::string TTask::Cols::_max_retry_interval = "max_retry_interval";
const std::string TTask::Cols::_schedule_log = "schedule_log";
const std::string TTask::Cols::_task_context = "task_context";
const std::string TTask::Cols::_order_time = "order_time";
const std::string TTask::Cols::_create_time = "create_time";
const std::string TTask::Cols::_modify_time = "modify_time";
const std::string TTask::primaryKeyName = "id";
const bool TTask::hasPrimaryKey = true;
const std::string TTask::tableName = "t_<taskType>_task_<pos>";

const std::vector<typename TTask::MetaData> TTask::metaData_ = {
...
const std::string& TTask::getColumnName(size_t index) noexcept(false)
{
    assert(index < metaData_.size());
    return metaData_[index].colName_;
}
TTask::TTask(const Row& r, const ssize_t indexOffset) noexcept
{
    if (indexOffset < 0)
    {
        if (!r["id"].isNull())
...
TTask::TTask(const Json::Value& pJson, const std::vector<std::string>& pMasqueradingVector) noexcept(false)
{
...
TTask::TTask(const Json::Value& pJson) noexcept(false)
{
...
void TTask::updateByMasqueradedJson(const Json::Value& pJson,
...
void TTask::updateByJson(const Json::Value& pJson) noexcept(false)
{
    if (pJson.isMember("id"))
    {
        if (!pJson["id"].isNull())
...
const int32_t& TTask::getValueOfId() const noexcept
{
...
const std::shared_ptr<int32_t>& TTask::getId() const noexcept
{
    return id_;
}
void TTask::setId(const int32_t& pId) noexcept
{
    id_ = std::make_shared<int32_t>(pId);
    dirtyFlag_[0] = true;
}
const typename TTask::PrimaryKeyType& TTask::getPrimaryKey() const
{
    assert(id_);
    return *id_;
}

const std::string& TTask::getValueOfUserId() const noexcept
{
...
const std::shared_ptr<std::string>& TTask::getUserId() const noexcept
{
    return userId_;
}
void TTask::setUserId(const std::string& pUserId) noexcept
{
    userId_ = std::make_shared<std::string>(pUserId);
    dirtyFlag_[1] = true;
}
void TTask::setUserId(std::string&& pUserId) noexcept
{
    userId_ = std::make_shared<std::string>(std::move(pUserId));
    dirtyFlag_[1] = true;
}

const std::string& TTask::getValueOfTaskId() const noexcept
{
    const static std::string defaultValue = std::string();
    if (taskId_)
        return *taskId_;
...
const std::shared_ptr<std::string>& TTask::getTaskId() const noexcept
{
    return taskId_;
}
void TTask::setTaskId(const std::string& pTaskId) noexcept
{
    taskId_ = std::make_shared<std::string>(pTaskId);
    dirtyFlag_[2] = true;
}
void TTask::setTaskId(std::string&& pTaskId) noexcept
{
    taskId_ = std::make_shared<std::string>(std::move(pTaskId));
    dirtyFlag_[2] = true;
}

const std::string& TTask::getValueOfTaskType() const noexcept
{
    const static std::string defaultValue = std::string();
    if (taskType_)
        return *taskType_;
...
const std::shared_ptr<std::string>& TTask::getTaskType() const noexcept
{
    return taskType_;
}
void TTask::setTaskType(const std::string& pTaskType) noexcept
{
    taskType_ = std::make_shared<std::string>(pTaskType);
    dirtyFlag_[3] = true;
}
void TTask::setTaskType(std::string&& pTaskType) noexcept
{
    taskType_ = std::make_shared<std::string>(std::move(pTaskType));
    dirtyFlag_[3] = true;
}

const std::string& TTask::getValueOfTaskStage() const noexcept
{
    const static std::string defaultValue = std::string();
    if (taskStage_)
        return *taskStage_;
...
const std::shared_ptr<std::string>& TTask::getTaskStage() const noexcept
{
    return taskStage_;
}
void TTask::setTaskStage(const std::string& pTaskStage) noexcept
{
    taskStage_ = std::make_shared<std::string>(pTaskStage);
    dirtyFlag_[4] = true;
}
void TTask::setTaskStage(std::string&& pTaskStage) noexcept
{
    taskStage_ = std::make_shared<std::string>(std::move(pTaskStage));
    dirtyFlag_[4] = true;
}

const uint8_t& TTask::getValueOfStatus() const noexcept
{
...
const std::shared_ptr<uint8_t>& TTask::getStatus() const noexcept
{
    return status_;
}
void TTask::setStatus(const uint8_t& pStatus) noexcept
{
    status_ = std::make_shared<uint8_t>(pStatus);
    dirtyFlag_[5] = true;
}

const int32_t& TTask::getValueOfPriority() const noexcept
{
    const static int32_t defaultValue = int32_t();
    if (priority_)
        return *priority_;
...
const std::shared_ptr<int32_t>& TTask::getPriority() const noexcept
{
    return priority_;
}
void TTask::setPriority(const int32_t& pPriority) noexcept
{
    priority_ = std::make_shared<int32_t>(pPriority);
    dirtyFlag_[6] = true;
}

const int32_t& TTask::getValueOfCrtRetryNum() const noexcept
{
    const static int32_t defaultValue = int32_t();
    if (crtRetryNum_)
        return *crtRetryNum_;
...
const std::shared_ptr<int32_t>& TTask::getCrtRetryNum() const noexcept
{
    return crtRetryNum_;
}
void TTask::setCrtRetryNum(const int32_t& pCrtRetryNum) noexcept
{
    crtRetryNum_ = std::make_shared<int32_t>(pCrtRetryNum);
    dirtyFlag_[7] = true;
}

const int32_t& TTask::getValueOfMaxRetryNum() const noexcept
{
    const static int32_t defaultValue = int32_t();
    if (maxRetryNum_)
        return *maxRetryNum_;
...
const std::shared_ptr<int32_t>& TTask::getMaxRetryNum() const noexcept
{
    return maxRetryNum_;
}
void TTask::setMaxRetryNum(const int32_t& pMaxRetryNum) noexcept
{
    maxRetryNum_ = std::make_shared<int32_t>(pMaxRetryNum);
    dirtyFlag_[8] = true;
}

const int32_t& TTask::getValueOfMaxRetryInterval() const noexcept
{
    const static int32_t defaultValue = int32_t();
...
const std::shared_ptr<int32_t>& TTask::getMaxRetryInterval() const noexcept
{
    return maxRetryInterval_;
}
void TTask::setMaxRetryInterval(const int32_t& pMaxRetryInterval) noexcept
{
    maxRetryInterval_ = std::make_shared<int32_t>(pMaxRetryInterval);
    dirtyFlag_[9] = true;
}

const std::string& TTask::getValueOfScheduleLog() const noexcept
{
    const static std::string defaultValue = std::string();
    if (scheduleLog_)
        return *scheduleLog_;
...
const std::shared_ptr<std::string>& TTask::getScheduleLog() const noexcept
{
    return scheduleLog_;
}
void TTask::setScheduleLog(const std::string& pScheduleLog) noexcept
{
    scheduleLog_ = std::make_shared<std::string>(pScheduleLog);
    dirtyFlag_[10] = true;
}
void TTask::setScheduleLog(std::string&& pScheduleLog) noexcept
{
    scheduleLog_ = std::make_shared<std::string>(std::move(pScheduleLog));
    dirtyFlag_[10] = true;
}

const std::string& TTask::getValueOfTaskContext() const noexcept
{
    const static std::string defaultValue = std::string();
    if (taskContext_)
        return *taskContext_;
...
const std::shared_ptr<std::string>& TTask::getTaskContext() const noexcept
{
    return taskContext_;
}
void TTask::setTaskContext(const std::string& pTaskContext) noexcept
{
    taskContext_ = std::make_shared<std::string>(pTaskContext);
    dirtyFlag_[11] = true;
}
void TTask::setTaskContext(std::string&& pTaskContext) noexcept
{
    taskContext_ = std::make_shared<std::string>(std::move(pTaskContext));
    dirtyFlag_[11] = true;
}

const int32_t& TTask::getValueOfOrderTime() const noexcept
{
    const static int32_t defaultValue = int32_t();
    if (orderTime_)
        return *orderTime_;
...
const std::shared_ptr<int32_t>& TTask::getOrderTime() const noexcept
{
    return orderTime_;
}
void TTask::setOrderTime(const int32_t& pOrderTime) noexcept
{
    orderTime_ = std::make_shared<int32_t>(pOrderTime);
    dirtyFlag_[12] = true;
}

const ::trantor::Date& TTask::getValueOfCreateTime() const noexcept
{
...
const std::shared_ptr<::trantor::Date>& TTask::getCreateTime() const noexcept
{
    return createTime_;
}
void TTask::setCreateTime(const ::trantor::Date& pCreateTime) noexcept
{
    createTime_ = std::make_shared<::trantor::Date>(pCreateTime);
    dirtyFlag_[13] = true;
}

const ::trantor::Date& TTask::getValueOfModifyTime() const noexcept
{
    const static ::trantor::Date defaultValue = ::trantor::Date();
    if (modifyTime_)
        return *modifyTime_;
...
const std::shared_ptr<::trantor::Date>& TTask::getModifyTime() const noexcept
{
    return modifyTime_;
}
void TTask::setModifyTime(const ::trantor::Date& pModifyTime) noexcept
{
    modifyTime_ = std::make_shared<::trantor::Date>(pModifyTime);
    dirtyFlag_[14] = true;
}

void TTask::updateId(const uint64_t id)
{
    id_ = std::make_shared<int32_t>(static_cast<int32_t>(id));
}

const std::vector<std::string>& TTask::insertColumns() noexcept
{
...
void TTask::outputArgs(drogon::orm::internal::SqlBinder& binder) const
{
    if (dirtyFlag_[1])
    {
        if (getUserId())
...
const std::vector<std::string> TTask::updateColumns() const
{
...
void TTask::updateArgs(drogon::orm::internal::SqlBinder& binder) const
{
    if (dirtyFlag_[1])
    {
        if (getUserId())
...
Json::Value TTask::toMasqueradedJson(
...
bool TTask::validateJsonForCreation(const Json::Value& pJson, std::string& err)
{
    if (pJson.isMember("id"))
    {
...
bool TTask::validateMasqueradedJsonForCreation(const Json::Value& pJson,
...
bool TTask::validateJsonForUpdate(const Json::Value& pJson, std::string& err)
{
    if (pJson.isMember("id"))
    {
...
bool TTask::validateMasqueradedJsonForUpdate(const Json::Value& pJson,
    const std::vector<std::string>& pMasqueradingVector,
    std::string& err)
{
    if (pMasqueradingVector.size() != 15)
...
bool TTask::validJsonOfField(size_t index,
