...
-- ALTER USER 'root'@'%' IDENTIFIED WITH mysql_native_password BY 'apiao0509';
...
CREATE TABLE `t_schedule_pos` (
                                  ...
                                  `data_begin_pos` int(11) NOT NULL DEFAULT '0' COMMENT '数据从第几号表开始',
                                  `data_end_pos` int(11) NOT NULL DEFAULT '0' COMMENT '数据从第几号表结束',
...
insert into t_schedule_pos(task_type, data_begin_pos, data_end_pos, schedule_begin_pos,schedule_end_pos) 
values("t_lark_task", 1, 1, 1, 1);